...
namespace Net
{
    ...
    bool ReliabilitySystem::IsSequenceMoreRecent( unsigned int s1, unsigned int s2, unsigned int max_sequence ) {
    ...
    unsigned int ReliabilitySystem::GenerateAckBits(unsigned int ack,
